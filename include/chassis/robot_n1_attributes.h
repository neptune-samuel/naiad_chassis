...
#define ATTR_BOARD_HUMITUDY(_val) 		sacp::Attribute(121, (float)_val) 		/* 121  ATTR_BOARD_HUMITUDY                      float  RD */
...
#define ATTR_FOGBOX_HUMITUDY(_val) 		sacp::Attribute(361, (float)_val) 		/* 361  ATTR_FOGBOX_HUMITUDY                     float  RD */
...
#define ATTR_PUMPBOX_HUMITUDY(_val) 		sacp::Attribute(261, (float)_val) 		/* 261  ATTR_PUMPBOX_HUMITUDY                    float  RD */
...
#define ATTR_POWERBOX_HUMITUDY(_val) 		sacp::Attribute(211, (float)_val) 		/* 211  ATTR_POWERBOX_HUMITUDY                   float  RD */
...
#define ATTR_PUSHBOX_HUMITUDY(_val) 		sacp::Attribute(312, (float)_val) 		/* 312  ATTR_PUSHBOX_HUMITUDY                    float  RD */
...
#define ATTR_PUSHBOX_BATTERY_ALARM_STATUS(_val) 		sacp::Attribute(320, (uint16_t)_val) 		/* 320  ATTR_PUSHBOX_BATTERY_ALARM_STATUS        uint16_t RD */
#define ATTR_PUSHBOX_OFFLINE_PUSH_ENABLE(_val) 		sacp::Attribute(321, (bool)_val) 		/* 321  ATTR_PUSHBOX_OFFLINE_PUSH_ENABLE         bool   RW */
#define ATTR_PUSHBOX_OFFLINE_PUSH_DELAY_TIME(_val) 		sacp::Attribute(322, (uint16_t)_val) 		/* 322  ATTR_PUSHBOX_OFFLINE_PUSH_DELAY_TIME     uint16_t RW */
#define ATTR_PUSHBOX_CONTROL(_val) 		sacp::Attribute(323, (uint8_t)_val) 		/* 323  ATTR_PUSHBOX_CONTROL                     uint8_t RW */
...
#define ATTR_LEDLIGHT_A_HUMITUDY(_val) 		sacp::Attribute(412, (float)_val) 		/* 412  ATTR_LEDLIGHT_A_HUMITUDY                 float  RD */
...
#define ATTR_LEDLIGHT_B_HUMITUDY(_val) 		sacp::Attribute(437, (float)_val) 		/* 437  ATTR_LEDLIGHT_B_HUMITUDY                 float  RD */
...
#define ATTR_LEDLIGHT_C_HUMITUDY(_val) 		sacp::Attribute(462, (float)_val) 		/* 462  ATTR_LEDLIGHT_C_HUMITUDY                 float  RD */
...
#define ATTR_LEDLIGHT_D_HUMITUDY(_val) 		sacp::Attribute(487, (float)_val) 		/* 487  ATTR_LEDLIGHT_D_HUMITUDY                 float  RD */
